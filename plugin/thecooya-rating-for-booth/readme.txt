...
= 2.9 =
* The shortcode now accepts an optional Order parameter. In case you want to set it to ASC instead of the default DESC.

= 2.8 =
* Added Italian translation it_IT

= 2.7 =
* Added Danish translation dk_DK

= 2.6 =
* The shortcode for the most voted list now excludes the sticky posts. Otherwise they would show up on top even without any votes. Props @mirluin
...
= 2.6 =
* The shortcode for the most voted list now excludes the sticky posts.
